! function(a) {
    function b() {
        ...
        a.ajax({
            url: "/widget/support",
            data: {
                subject: a(".x-subject", b).val(),
                message: a(".x-message", b).val(),
                email: a(".x-email", b).val()
            },
            type: "post",
            dataType: "JSON",
            success: function(c) {
                c.success ? (a(".x-warning-message", b).addClass("hidden"), a(".x-success-message", b).html(c.message), a(".x-success-message", b).removeClass("hidden")) : (a(".x-success-message", b).addClass("hidden"), a(".x-warning-message", b).html(c.message), a(".x-warning-message", b).removeClass("hidden"))
            }
        })
    }
    ...
    function c() {
        var b = this,
            c = a("<div></div>");
        c.addClass("x-backdrop modal-backdrop fade"), a("body").append(c), a(b).removeClass("hidden"), setTimeout(function() {
            a(".x-backdrop").addClass("in"), a(b).addClass("in"), a(".x-subject", b).focus()
        }, 10)
    }
    ...
    function d() {
        var b = this;
        setTimeout(function() {
            a(b).removeClass("in"), a(".x-backdrop").removeClass("in"), setTimeout(function() {
                a(".x-backdrop").addClass("hidden"), a(".x-backdrop").remove(), a(b).addClass("hidden")
            }, 100)
        }, 10)
    }
}(jQuery),
function(a) {
    function b() {
        var b = a("<div></div>");
        b.addClass("x-backdrop modal-backdrop fade"), a("body").append(b), a("#x-login-dialog").removeClass("hidden"), setTimeout(function() {
            a(".x-backdrop").addClass("in"), a("#x-login-dialog").addClass("in")
        }, 10)
    }

    function c() {
        setTimeout(function() {
            a("#x-login-dialog").removeClass("in"), a(".x-backdrop").removeClass("in"), setTimeout(function() {
                a(".x-backdrop").addClass("hidden"), a(".x-backdrop").remove(), a("#x-login-dialog").addClass("hidden")
            }, 100)
        }, 10)
    }
    a.fn.extend({
        vvLoginBox: function(d) {
            return this.each(function() {
                a(".x-open-login-box").click(function(c) {
                    a(window).width() > 767 && (c.preventDefault(), b())
                }), a("#x-login-dialog .close").click(function(a) {
                    a.preventDefault(), c()
                }), a(document).on("click", ".x-backdrop", function(a) {
                    a.preventDefault(), c()
                })
            })
        }
...
function(a) {
    function b() {
        var b = new Fingerprint(c(this)).get();
        a.ajax({
    ...
    function c(b) {
        return a.data(b, "vvRecordTraffic")
    }
    a.vvRecordTraffic = {
        defaults: {
            canvas: !0,
        ...
        vvRecordTraffic: function(c) {
            return this.each(function() {
                c = a.extend({}, a.vvRecordTraffic.defaults, c), a.data(this, "vvRecordTraffic", c);
                var d = this;
                b.call(d)
            })
        }
        ...
        b = function() {
            ...
            var b, c, d = this,
                e = {};
            d.options.rtl === !0 && (a = -a), b = "left" == d.positionProp ? Math.ceil(a) + "px" : "0px", c = "top" == d.positionProp ? Math.ceil(a) + "px" : "0px", e[d.positionProp] = a, d.transformsEnabled === !1 ? d.$slideTrack.css(e) : (e = {}, d.cssTransitions === !1 ? (e[d.animType] = "translate(" + b + ", " + c + ")",
                d.$slideTrack.css(e)) : (e[d.animType] = "translate3d(" + b + ", " + c + ", 0px)", d.$slideTrack.css(e)))
        ...
        var a = $(".sitemap__category-title"),
            b = "_opened";
        a.click(function() {
            var c = $(this).hasClass(b);
            a.removeClass(b), $(this).toggleClass(b, !c)
        })
    }), $(function() {
        var a = $(".description__variant, .description__menu-item");
        $(".description__menu-item").click(function() {
            var b = this.getAttribute("data-type");
            a.each(function(a, c) {
                c.getAttribute("data-type") === b ? $(c).addClass("_active") : $(c).removeClass("_active")
            })
        })
    }), $(function() {
        var a = $(".header__categories"),
            b = $(".header__categories-button");
        b.click(function() {
            a.toggleClass("_hidden"), b.toggleClass("_categories-shown")
        })
    }), $(function() {
        var a = $(".header").height();
        $(".billboard__arrow").on("click", function() {
            $("body").animate({
                scrollTop: $(".billboard").height() - a
            }, 500)
        })
    }), $(function() {
        var a, b = "_expanded";
        $(".description__feature-title").on("click", function() {
            ...
            a && a !== this && $(a).removeClass(b), $(this).toggleClass(b), a = this
        })
    }), $(function() {
        $(".x-carousel").slick({
            dots: !0,
        ...
        $(document).bind("click", function(a) {
            0 === $(a.target).closest(".x-city-billboard").length && $(".x-city-input").attr("checked", !1)
        })
    }), $(setTimeout(function() {
        var a = $("body"),
            b = $(".x-all-cities", a),
            c = "body-fix",
            d = "all-cities--show";
        a.on("click", ".x-show-all-cities", function() {
            a.addClass(c), b.addClass(d), $(".x-city-search", a).focus()
        }), a.on("click", ".x-hide-all-cities", function() {
            a.removeClass(c), b.removeClass(d), $(".x-city-search", a).val("").trigger("input")
        }), $(document).keyup(function(c) {
            27 == c.keyCode && b.hasClass(d) && $(".x-hide-all-cities", a).trigger("click")
        })
        ...
        var a = $("body"),
            ...
            d = c.toArray(),
            e = "x-hidden",
            f = $(".x-city-alphabet ul").toArray(),
            g = $(".x-city-alphabet", a),
            h = $(".x-not-found", a),
            i = [];
        d.forEach(function(a, b, c) {
            var d = a.innerText.toLowerCase().replace(/ {1,}/g, " ");
            d = $.trim(d);
            var e = $(a).closest("li"),
                f = $(a).closest("ul");
            i[b] = {
        ...
        }), a.on("input", ".x-city-search", function(a) {
            var d = b.val().toString().toLowerCase().replace(/(^\s+)/g, "").replace(/ {1,}/g, " ");
            d ? (i.forEach(function(a, b, c) {
                var f = a.cityText,
                    i = a.li,
                    j = a.ul; - 1 === f.indexOf(d) ? i.addClass(e) : (i.removeClass(e), j.removeClass(e), g.removeClass(e), h.addClass(e))
            }), f.forEach(function(a, b, c) {
                var d = $(a);
                d.find(".x-city").is(":visible") || d.addClass(e)
            }), $(".x-city-alphabet ul").is(":visible") || (g.addClass(e), h.removeClass(e))) : (c.closest("li").removeClass(e), c.closest("ul").removeClass(e), h.addClass(e), g.removeClass(e))
        })
    }, 1200)),
    function(a) {
        function b(b) {
        ...
        function c(b) {
            for (var c = b.length, d = 0; c > d; d++) {
                var e = a(".x-hori[data-key=" + b[d].key + "]");
                e.length && e.replaceWith(b[d].content)
            }
        }
        a.vvHoriWatcher = {}, a.fn.extend({
            vvHoriWatcher: function(c) {
                return this.each(function() {
                    var c = a("span.x-hori").length,
                        d = [],
                        e = 0;
                    a("span.x-hori").each(function() {
                        d.push(a(this).data("key")), e++, e == c && b(d)
                    })
                })
            }
        })
    }(jQuery), $(document).ready(function() {
        $(document).vvHoriWatcher()
    });