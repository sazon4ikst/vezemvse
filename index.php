      ...
      <div class="feedbacks__all">
        <a href="otzyvy.html" class="feedbacks__button">Посмотреть все отзывы</a>
			...
			<article class="collaboration">
				<div class="collaboration__content">
					<header class="collaboration__header">
						<div class="collaboration__header-title">
							Дополнительно
						</div>
					</header>
					<div class="collaboration__option _private">
						<div class="collaboration__title">
							<a class="collaboration__title-link" href="https://www.vezemvse.com.ua/carrier_landing">Частным перевозчикам</a>
						</div>
						<div class="collaboration__description">
							Выбирайте заказы и&nbsp;находите догруз
						</div>
					</div>
					<div class="collaboration__option _company">
						<div class="collaboration__title">
							<a class="collaboration__title-link" href="https://www.vezemvse.com.ua/carrier_landing">Транспортным кампаниям</a>
						</div>
						<div class="collaboration__description">
							Специальные условия для&nbsp;профессиональных компаний
						</div>
					</div>
					<div class="collaboration__option _ecommerce">
						<div class="collaboration__title">
							<a class="collaboration__title-link" href="https://www.vezemvse.com.ua/carrier_landing">Интернет-магазинам</a>
						</div>
						<div class="collaboration__description">
							Организуем доставку ваших товаров в&nbsp;любую точку Украины и&nbsp;Европы
						</div>
					</div>
					<div class="collaboration__option _application">
						<div class="collaboration__title">
							<a class="collaboration__title-link" href="http://www.vezemvse.com.ua/app_for_merchant">Приложение для заказчиков</a>
						</div>
						<div class="collaboration__description">
							Простое и&nbsp;понятное приложение для выбора перевозчика с&nbsp;лучшим предложением
						</div>
					</div>
				</div>
			</article>
			...
			<article class="sitemap">
				<div class="sitemap__content layout__container">
					<div class="sitemap__category">
						<div class="sitemap__category-title">Категории перевозок</div>
						<ul class="sitemap__list">
							<li class="sitemap__link"><a href="gorod.html">Перевозки межгород</a>
							</li>
							<li class="sitemap__link"><a href="perevozka-mebeli.html">Перевозка мебели</a>
							</li>
							<li class="sitemap__link"><a href="perevozka-veshej.html">Перевезти вещи</a>
							</li>
							<li class="sitemap__link"><a href="perevozka-avtomobilej/avtovozom.html">Перевозка автовозом</a>
							</li>
							<li class="sitemap__link"><a href="perevozka-avtomobilej.html">Перевозка автомобилей</a>
							</li>
							<li class="sitemap__link"><a href="pereezd.html">Квартирный переезд</a>
							</li>
							<li class="sitemap__link"><a href="gruzoperevozki.html">Грузоперевозки</a>
							</li>
							<li class="sitemap__link"><a href="pereezd/ofisnyj.html">Переезд офиса</a>
							</li>
							<li class="sitemap__link"><a href="mashina-dlya-perevozki-gruza/gazel.html">Заказ газели</a>
							</li>
							<li class="sitemap__link"><a href="passazhirskie-perevozki.html">Пассажирские перевозки</a>
							</li>
							<li class="sitemap__link"><a href="perevozka-bytovoy-tehniki/holodilnik.html">Перевозка холодильника</a>
							</li>
					...
					<div class="sitemap__category">
						<div class="sitemap__category-title">Дополнительно</div>
						<ul class="sitemap__list">
							<li class="sitemap__link"><a href="#">О «Везём Всё»</a>
							</li>
							<li class="sitemap__link"><a href="contacts.html">Контакты</a>
							</li>
							<li class="sitemap__link"><a href="tracking_promo.html">Отслеживание груза</a>
							</li>
							<li class="sitemap__link"><a href="pressa.html">Пресса о нас</a>
							</li>
							<li class="sitemap__link"><a href="creative.html">Возим всё!</a>
							</li>
							<li class="sitemap__link"><a href="rating_carriers.html">Каталог перевозчиков</a>
							</li>
							<li class="sitemap__link"><a href="carrier_landing.html">Для перевозчиков</a>
							</li>
							<li class="sitemap__link"><a href="owners.html">Для заказчиков</a>
							</li>
							<li class="sitemap__link"><a href="otzyvy.html">Отзывы</a>
							</li>
							<li class="sitemap__link"><a href="rating.html">Рейтинг перевозчиков</a>
							</li>
							<li class="sitemap__link"><a href="help.html">Помощь</a>
							</li>
							<li class="sitemap__link"><a href="ecology.html">Экология</a>
							</li>
							<li class="sitemap__link"><a href="insurance.html">Страховка</a>
							</li>
							<li class="sitemap__link"><a href="discount.html">Акция</a>
							</li>
							<li class="sitemap__link"><a href="tools.html">Инструменты для работы перевозчика</a>
							</li>
						</ul>
					</div>
				</div>
							...
							<div class="contacts__column-left">
								<div class="contacts__section contacts__section--address">
									<div class="contacts__section-judge">
										...
										02000, Киев, Днепровская Набережная&nbsp;14Б, офис&nbsp;1603
									</div>
								</div>
