					...
					<div class="new_detalizacia" id="order-info">
						...
						<div class="det_button">
							...
							<?php } else if (empty($session_user_id)){ ?>
								<a class="vi_perevozchik" href="/kak_rabotat?gruz=<?php echo $id ?>" style="cursor:pointer; margin-bottom:40px; font-weight:500; font-size:18px; padding:13px 30px 15px 30px; line-height:25px">
