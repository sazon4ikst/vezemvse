...
<head>
	...
	<link type="text/css" rel="stylesheet" href="https://www.vezetvsem.ru/assets/styles/pages/listing/represent_old.css" media="screen">
			...
			<div class="top_bg_order" style="padding-bottom:15px;">
				<div class="list_new" style="margin-left:-100px">
					<div class="l_sakascik" style="margin-left:100px">
						<p>Если вы хотите перевезти груз</p>
						<a href="/booking"><div class="dn"></div></a>
						<div class="l_but"><a href="/booking"><span>Разместить запрос на перевозку</span> и сэкономить до 70%</a></div>
					</div>
					<div class="l_perevos">
						<p>Если вы перевозчик</p>
						<a href="../registration/step0"><div class="dn"></div></a>
						<div class="l_but"><a href="../registration/step0"><span>Зарегистрироваться</span> и получать новые заказы</a></div>
					</div>
				</div>
			</div>
		</div>
